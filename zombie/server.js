...
var socketIO = require("socket.io/lib/socket.io");

/*
var s = dgram.createSocket("udp4");
    s.bind("8080",function() {
        s.addMembership("27.0.0.1");
    });*/
...
var SampleApp = function() {
    ...
    self.createRoutes = function() {
        ...
        require("./controllers/AccountController")(self,mongoose);
    ...
    self.start = function() {
        ...
        self.app.listen(self.port, self.ipaddress, function() {
            ...
            mongoose.connection.on("opened", function() {
                console.log("A connection to a MongoDB database has been established");
            });

            mongoose.connection.on("error", function() {
                console.log("An error occured while trying to connect to MongoDB");
            });
            //  console.log("The env variables for MongoDB -->");
            // console.log(process.env.OPENSHIFT_MONGODB_DB_HOST+":"+process.env.OPENSHIFT_MONGODB_DB_PORT);
