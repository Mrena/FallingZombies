...
public class AmazonGameCircleExampleWSNumberList {
    ...
    public void DrawGUI(AGSGameDataMap dataMap) {
        ...
        if(null == dataMap) {
            AmazonGameCircleExampleGUIHelpers.CenteredLabel(notInitializedLabel);
            return;
        }
        ...
        foldout = AmazonGameCircleExampleGUIHelpers.FoldoutWithLabel(foldout,ListName());
        ...
        if(foldout) {
            ...
            AmazonGameCircleExampleGUIHelpers.CenteredLabel(string.Format(isListSetLabel,isSet));
            
            // This label displays the max size (if the size has been retrieved).
            if(maxSize.HasValue) {
                maxSize = (int)AmazonGameCircleExampleGUIHelpers.DisplayCenteredSlider((float)maxSize.Value,minMaxSize,maxMaxSize,maxSizeLabel);
            ...
            if(null == syncableNumberElementsCache || 0 == syncableNumberElementsCache.Length) {
                AmazonGameCircleExampleGUIHelpers.CenteredLabel(emptyListLabel);
            }
