...
public class AmazonGameCircleExampleInitialization : AmazonGameCircleExampleBase {
    ...
    public override void DrawMenu() {        
        ...
        case EInitializationStatus.InitializationRequested:
            AmazonGameCircleExampleGUIHelpers.BoxedCenteredLabel(pluginName);
    ...
    private void DisplayInitGameCircleMenu() {
        ...
        AmazonGameCircleExampleGUIHelpers.AnchoredLabel(toastLocationLabel,TextAnchor.LowerCenter);
    ...
    private void DisplayLoadingGameCircleMenu() {
        ...
        AmazonGameCircleExampleGUIHelpers.CenteredLabel(string.Format(loadingTimeLabel,(System.DateTime.Now - initRequestTime).TotalSeconds));
    }
