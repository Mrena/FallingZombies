...
public class AGSClient : MonoBehaviour
{
    ...
    private static extern void _AmazonGameCircleInit(string unityCallbackObject, int loggingLevel, bool supportsLeaderboards, bool supportsAchievements, bool supportsWhispersync);
    
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleSetPopUpEnabled(bool enabled);
    
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleSetPopUpLocation(int position);
    
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleRelease();
    
    [DllImport ("__Internal")]
    private static extern void _AmazonGameCircleShowGameCircleOverlay(bool isAnimated);
#endif
...
#elif UNITY_IOS
        _AmazonGameCircleInit("GameCircleManager", (int) errorLevel, supportsLeaderboards,supportsAchievements,supportsWhispersync);
#else
...
#elif UNITY_IOS
        _AmazonGameCircleSetPopUpEnabled(enabled);
#endif
    }
...
#elif UNITY_IOS
        _AmazonGameCircleSetPopUpLocation((int)location);
#endif
    }
...
#elif UNITY_IOS
        _AmazonGameCircleShowGameCircleOverlay(/*isAnimated*/ true);
#endif
    }
